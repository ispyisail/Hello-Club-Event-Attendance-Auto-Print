...
describe('API Client', () => {
  ...
  describe('getUpcomingEvents', () => {
    ...
    it('should handle 401 unauthorized error', async () => {
      ...
      await expect(getUpcomingEvents(24)).rejects.toThrow(
  ...
  describe('getEventDetails', () => {
    ...
    it('should handle 404 not found error', async () => {
      ...
      await expect(getEventDetails('999')).rejects.toThrow(
        /API Error: 404/
      );
    });
  });
  ...
  describe('getAllAttendees', () => {
    ...
    it('should sort attendees by lastName, firstName', async () => {
      ...
      mockAxiosInstance.get
        ...
        .mockResolvedValueOnce({ data: { attendees: [], meta: { total: 3 } } });
    ...
    it('should respect 1-second delay between pagination requests', async () => {
      ...
      mockAxiosInstance.get
        .mockResolvedValueOnce(mockPage1)
        .mockResolvedValueOnce(mockPage2)
        .mockResolvedValueOnce({ data: { attendees: [], meta: { total: 2 } } });
    ...
    it('should handle pagination error gracefully', async () => {
      ...
      await expect(getAllAttendees('123')).rejects.toThrow(/API Error: 500/);
    });
  });
  ...
  describe('Error Context', () => {
    it('should include context in error messages for events', async () => {
      ...
      await expect(getUpcomingEvents(24)).rejects.toThrow(/fetching upcoming events/);
    });
    ...
    it('should include context in error messages for event details', async () => {
      ...
      await expect(getEventDetails('123')).rejects.toThrow(/fetching details for event 123/);
    });
    ...
    it('should include context in error messages for attendees', async () => {
      ...
      await expect(getAllAttendees('123')).rejects.toThrow(/fetching attendees for event 123/);
    });
  });
});
